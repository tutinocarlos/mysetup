	...
	public function users($groups = NULL)
	{
		...
		else
		{
			...
			$this->db->select([
			    ...
			    $this->tables['empresa'].'.id',
			    $this->tables['empresa'].'.nombre_empresa',
			    $this->tables['empresa'].'.email_empresa',
			    $this->tables['empresa'].'.app',
			]);
		}
		
						$this->db->join(
				    $this->tables['empresa'],
				    $this->tables['empresa'].'.'.$this->join['empresa'].'='.$this->tables['users'].'.id_empresa',
				    'left'
				);
