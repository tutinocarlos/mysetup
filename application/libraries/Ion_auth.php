...
class Ion_auth
{
	...
	public function is_clientes($id = FALSE)
	{

		$this->ion_auth_model->trigger_events('is_clientes');

		$clientes_group = $this->config->item('clientes_group', 'ion_auth');

		return $this->ion_auth_model->in_group($clientes_group, $id);
	}
